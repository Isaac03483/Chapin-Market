...
public class ClientCardController {
    ...
    @PostMapping
    public ResponseEntity<ClientCardResponse> addClientCard(@RequestBody @Valid ClientCardRequest clientCard) {
    ...
    @PutMapping
    @Transactional
    public ResponseEntity<ClientCardResponse> improveClientCard(@RequestBody @Valid ClientCardRequest clientCard) {
